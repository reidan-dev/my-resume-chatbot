...
I stay current mainly through building things rather than just reading about them. For example, I integrated Claude Code and OpenAI Codex into my actual workflow at Biarri — not just experimenting — which gave me a fast and practical ramp on AI-augmented development. I'm currently building a resume chatbot with a RAG pipeline (LangChain, ChromaDB, FastAPI, React) and a macOS virtual pet desktop app in SwiftUI/AppKit, and I've been experimenting with multi-agent AI workflows. Beyond that, I follow Hacker News regularly, take targeted online courses when I need structured depth on something new, and I lean on the actual documentation and source code more than tutorials when I need to learn something precisely.
...
On the LLM/AI tooling side: at Biarri I used Claude Code and OpenAI Codex in production-adjacent workflows — generating boilerplate endpoint scaffolding, accelerating integration test authoring, and eliminating repetitive developer tasks. I'm now building further in this space through side projects: a RAG-based resume chatbot using LangChain, ChromaDB, and the Claude API, and experiments with multi-agent orchestration. My goal is to move from integrating AI into workflows to architecting AI-driven systems end-to-end.
...
- Side projects: resume chatbot with RAG pipeline (LangChain, ChromaDB/Pinecone, FastAPI, React, Claude API); Eevee virtual pet macOS desktop app (SwiftUI/AppKit); multi-agent AI workflow experiments — all showing initiative and continuous self-directed learning beyond the 9-to-5
